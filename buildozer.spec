...
version = 0.1
requirements = python3,kivy,kivymd==1.1.1,pillow,https://github.com/HyTurtle/plyer/archive/master.zip, requests, ffpyplayer, ffpyplayer_codecs, openssl, urllib3, mapview, kivy_garden, charset_normalizer, chardet, idna, android
